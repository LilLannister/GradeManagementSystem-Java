 ...
 * @author uguregecelik
 */
public class BestStudentReportFrame extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(BestStudentReportFrame.class.getName());

    /**
     * Creates new form BestStudentReportFrame
     */
    public BestStudentReportFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Header.setText("Best Student In Course");
    ...
    private void GenerateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GenerateButtonActionPerformed
        try {
            ...
            String query = "SELECT STID, CCode, Grade FROM Grades WHERE CCode='%s' ORDER BY Grade DESC LIMIT 1";
            ...
            if (result.next()) {
                ...
                JOptionPane.showMessageDialog(null, "No grade record found for this course.");
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new BestStudentReportFrame().setVisible(true));
    }
